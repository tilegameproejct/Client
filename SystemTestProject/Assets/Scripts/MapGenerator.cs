...
public class MapGenerator : MonoBehaviour {
    ...
    public void GenerateMap()
    {
        ...
        for (int i = 0; i < obstacleCount; ++i)
        {
            ...
            if (randomCoord != mapCenter && MapAccessible(obstacleMap, currentObstacleCount))
            {
    ...
    // Flood Fill 
    bool MapAccessible(bool[,] obstacleMap, int currentObstacleCount)
    {
